...
const (
	Service_SayHello_FullMethodName = "/hello.Service/SayHello"
)
...
func (c *serviceClient) SayHello(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedServiceServer) SayHello(context.Context, *Request) (*Response, error) {
...
func _Service_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).SayHello(ctx, req.(*Request))
	}
