...
import (
	transaction "github.com/k-vanio/grpc-proto/internal/proto-gen/transaction"
...
type Response struct {
	...
	Hash   *transaction.Hash `protobuf:"bytes,3,opt,name=hash,proto3" json:"hash,omitempty"`
}
...
func (x *Response) GetHash() *transaction.Hash {
	if x != nil {
		return x.Hash
	}
	return nil
...
var file_proto_payment_payment_proto_rawDesc = []byte{
	...
	,
	...
	0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x2d,
	0x76, 0x61, 0x6e, 0x69, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2d,
...
var file_proto_payment_payment_proto_goTypes = []interface{}{
	...
	(*transaction.Hash)(nil), // 2: transaction.Hash
}
var file_proto_payment_payment_proto_depIdxs = []int32{
	2, // 0: payment.Response.hash:type_name -> transaction.Hash
	0, // 1: payment.PaymentService.Pay:input_type -> payment.Request
	1, // 2: payment.PaymentService.Pay:output_type -> payment.Response
